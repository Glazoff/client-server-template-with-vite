...
export declare interface InternalResolveOptions
...
export declare interface PluginHookUtils {
  ...
  getSortedPluginHooks: <K extends keyof Plugin_2>(
    hookName: K,
  ) => NonNullable<HookHandler<Plugin_2[K]>>[]
}
...
export declare interface ResolvedBuildOptions
...
export declare type WebSocketCustomListener<T> = (
  data: T,
